...
var v = new Vue({
   el:'#userOrder',
    ...
    methods:{
         showAll(){ axios.get(this.url+"inventory/fetchAll").then(function(response){
          ...
          addItem(){   
            var formData = v.formData(v.newItem);
              axios.post(this.url+"order/addItem", formData).then(function(response){
        ...
        updateUser(){
            var formData = v.formData(v.chooseItem); axios.post(this.url+"order/addItem", formData).then(function(response){
                if(response.data.error){
                    v.formValidate = response.data.message;
                }else{
                      v.successMSG = response.data.message;
