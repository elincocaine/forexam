...
<div slot="body" class="row">
    ...
    <div class="btn-group">
        <button class="btn btn-outline-dark fa fa-mars" :class="{'active':(newUser.usertype == '1')}" @click.prevent="pickUsertype('1')"> ADMIN</button>
  <button class="btn btn-outline-dark fa fa-venus" :class="{'active': (newUser.usertype == '2')}" @click.prevent="pickUsertype('2')"> USER</button>
    </div>
  ...
  <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="password" :class="{'is-invalid': formValidate.password}" name="password" v-model="newUser.password" class="form-control">
...
<div slot="body" class="row">
    ...
    <label>Lastname</label>
     ...
     <label for="">Usertype</label><br>
    <div class="btn-group">
        <button class="btn btn-outline-dark fa fa-mars" :class="{'active':(chooseUser.usertype == '1')}" @click="changeUsertype('1')"> ADMIN </button>
  <button class="btn btn-outline-dark fa fa-venus" :class="{'active': (chooseUser.usertype == '2')}" @click="changeUsertype('2')"> USER</button>
    </div>
   <div  class="has-text-danger"v-html="formValidate.usertype"></div>
    </div>
    <div class="form-group">
